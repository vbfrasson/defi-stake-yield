...
def deploy_token_farm_and_dapp_token(front_end_update=False):
    ...
    # Fund TokenFarm bbut keep some balance of DAPP for tests
    tx = dapp_token.transfer(
        token_farm.address, dapp_token.totalSupply() - KEPT_BALANCE, {"from": account}
    )
    tx.wait(1)
    # Allow : dapp_token, weth_token, fau_token/dai
    weth_token = get_contract("weth_token")  # fake weth, locally deployed
...
# Add tokens allowed to be farmed
